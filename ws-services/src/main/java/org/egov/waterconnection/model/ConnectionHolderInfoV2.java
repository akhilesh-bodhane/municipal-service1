...
@AllArgsConstructor
@NoArgsConstructor
public class ConnectionHolderInfoV2 extends User {
    ...
    @Builder
    public ConnectionHolderInfoV2(Long id, String uuid, String userName, String password, String salutation, String name,
    ...
    public ConnectionHolderInfoV2 addDocumentsItem(Document documentsItem) {
