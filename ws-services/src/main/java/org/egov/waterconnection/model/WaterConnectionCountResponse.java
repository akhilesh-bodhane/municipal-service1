...
@Setter
@Builder
public class WaterConnectionCountResponse {
	@JsonProperty("ResponseInfo")
	private ResponseInfo responseInfo = null;

	@JsonProperty("WaterConnection")
	@Valid
	private List<WaterConnectionCount> waterConnection = null;

	public WaterConnectionCountResponse responseInfo(ResponseInfo responseInfo) {
	...
	public WaterConnectionCountResponse waterConnection(List<WaterConnectionCount> waterConnection) {
		this.waterConnection = waterConnection;
		return this;
	}

	public WaterConnectionCountResponse addWaterConnectionItem(WaterConnectionCount waterConnectionItem) {
		if (this.waterConnection == null) {
			this.waterConnection = new ArrayList<WaterConnectionCount>();
		}
	...
	@ApiModelProperty(value = "")
	@Valid
	public List<WaterConnectionCount> getWaterConnection() {
		return waterConnection;
	}

	public void setWaterConnection(List<WaterConnectionCount> waterConnection) {
		this.waterConnection = waterConnection;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		WaterConnectionCountResponse waterConnectionResponse = (WaterConnectionCountResponse) o;
