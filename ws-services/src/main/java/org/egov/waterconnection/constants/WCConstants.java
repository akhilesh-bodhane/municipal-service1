...
public class WCConstants {
	...
	public static final String ACTION_TEMPORARY_CLOSE_CONNECTION = "TEMPORARY_CLOSE_CONNECTION";
	...
	public static final List<String> DOC_CHECK_APP_STATUS_NOTIFY = Collections
			.unmodifiableList(Arrays.asList("PENDING_FOR_TUBEWELL_CONNECTION_ACTIVATION",
					"PENDING_FOR_CONNECTION_TARIFF_CHANGE", "PENDING_FOR_CONNECTION_REACTIVATION",
					"PENDING_FOR_CONNECTION_HOLDER_CHANGE", "PENDING_FOR_TEMPORARY_CONNECTION_CLOSE",
					"PENDING_FOR_CONNECTION_CLOSE", "PENDING_FOR_CONNECTION_EXTENSION_REGULAR",
	...
	public static final List<String> ADDITIONAL_OBJ_CONSTANT = Collections.unmodifiableList(
			Arrays.asList(ADHOC_PENALTY, ADHOC_REBATE, ADHOC_PENALTY_REASON, ADHOC_PENALTY_COMMENT, ADHOC_REBATE_REASON,
					ADHOC_REBATE_COMMENT, INITIAL_METER_READING_CONST, LAST_METER_READING_CONST, DETAILS_PROVIDED_BY,
	...
	public static final List<String> ACTIVITY_TYPE_81 = Collections.unmodifiableList(Arrays.asList(
			"CONNECTION_CONVERSION", "UPDATE_CONNECTION_HOLDER_INFO", "APPLY_FOR_TEMPORARY_REGULAR_CONNECTION"));

	public static final List<String> ACTIVITY_TYPE_82 = Collections
			.unmodifiableList(Arrays.asList("UPDATE_METER_INFO", "REACTIVATE_CONNECTION"));

	public static final List<String> ACTIVITY_TYPE_NEW_CONN = Collections
			.unmodifiableList(Arrays.asList("NEW_WS_CONNECTION"));
	...
	public static final Set<String> APPROVED_ACTIONS = Stream.of("TUBEWELL_CONNECTION_ACTIVATED",
			"CONNECTION_TARIFF_CHANGED", "CONNECTION_REACTIVATED", "CONNECTION_UPDATED", "TEMPORARY_CONNECTION_CLOSED",
			"CONNECTION_CLOSED", "CONNECTION_EXTENDED", "CONNECTION_TYPE_CHANGED", "CONNECTION_ACTIVATED")
			.collect(Collectors.toSet());
	public static final String WS_METER_TESTING_ACTIVITY = "APPLY_FOR_METER_TESTING";

	public static final int MIN_LENGTH = 14;
	public static final String PENDING_FOR_CONNECTION_NUMBER_BY_SUPERINTENDENT = "PENDING_FOR_CONNECTION_NUMBER_BY_SUPERINTENDENT";
