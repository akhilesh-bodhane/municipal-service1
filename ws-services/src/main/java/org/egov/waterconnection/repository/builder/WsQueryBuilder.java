...
public class WsQueryBuilder {
	...
	private static final String WATER_SEARCH_QUERY = "SELECT "
			...
			+ " property.id as waterpropertyid, property.usagecategory, property.usagesubcategory,property.ploatAreaTT,pta.doorno as propertyplotno,pta.locality as propertysectorno "
