...
public class WsQueryBuilder {
	...
	private static final String PUBLIC_DASHBOARD_WATER_SEARCH_TIME_TAKEN_APPROVED = "SELECT \r\n"
			+ "SUM(\r\n"
			+ "CEIL(\r\n"
			+ "        EXTRACT(EPOCH FROM (TO_TIMESTAMP(ewa.lastmodifiedtime / 1000) - TO_TIMESTAMP(ewa.createdtime / 1000))) / 3600 / 24\r\n"
			+ "    )) AS approveddays\r\n"
			+ " from eg_ws_application ewa ";
	
	private static final String PUBLIC_DASHBOARD_WATER_SEARCH_MINIMUM_TIME_TAKEN_APPROVED = "SELECT \r\n"
			+ "MIN(    \r\n"
			+ "CEIL(\r\n"
			+ "        EXTRACT(EPOCH FROM (TO_TIMESTAMP(ewa.lastmodifiedtime / 1000) - TO_TIMESTAMP(ewa.createdtime / 1000))) / 3600 / 24\r\n"
	...
	private static final String PUBLIC_DASHBOARD_WATER_SEARCH_MAXIMUM_TIME_TAKEN_APPROVED = "SELECT \r\n"
			+ "MAX(    \r\n"
			+ "CEIL(\r\n"
			+ "        EXTRACT(EPOCH FROM (TO_TIMESTAMP(ewa.lastmodifiedtime / 1000) - TO_TIMESTAMP(ewa.createdtime / 1000))) / 3600 / 24\r\n"
	...
	public static final String PUBLIC_DASHBOARD_WATER_SEARCH__APPROVED_DAYS = "SELECT \r\n"
			+ "CEIL(\r\n"
			+ "        EXTRACT(EPOCH FROM (TO_TIMESTAMP(ewa.lastmodifiedtime / 1000) - TO_TIMESTAMP(ewa.createdtime / 1000))) / 3600 / 24\r\n"
			+ "    ) AS approveddays\r\n"
			+ " FROM eg_ws_application ewa";
