...
@Setter
@Builder
public class SewerageCollectionCountResponse {
	@JsonProperty("ResponseInfo")
	private ResponseInfo responseInfo = null;

	@JsonProperty("SewerageConnection")
	@Valid
	private List<SewerageTotalCollections> waterConnection = null;

	public SewerageCollectionCountResponse responseInfo(ResponseInfo responseInfo) {
	...
	public SewerageCollectionCountResponse waterConnection(List<SewerageTotalCollections> waterConnection) {
		this.waterConnection = waterConnection;
		return this;
	}

	public SewerageCollectionCountResponse addWaterConnectionItem(SewerageTotalCollections waterConnectionItem) {
		if (this.waterConnection == null) {
			this.waterConnection = new ArrayList<SewerageTotalCollections>();
		}
	...
	@ApiModelProperty(value = "")
	@Valid
	public List<SewerageTotalCollections> getWaterConnection() {
		return waterConnection;
	}

	public void setWaterConnection(List<SewerageTotalCollections> waterConnection) {
		this.waterConnection = waterConnection;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		SewerageCollectionCountResponse waterConnectionResponse = (SewerageCollectionCountResponse) o;
