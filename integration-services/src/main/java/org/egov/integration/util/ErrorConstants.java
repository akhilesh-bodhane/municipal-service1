...
public class ErrorConstants {
	...
	public static final String INVALID_TENANT_ID_MDMS_SERVICE_CODE_KEY = "EG_MDMS_SERVICE_CODES";
	public static final String INVALID_TENANT_ID_MDMS_SERVICE_CODE_MSG = "No serviceDefs data found for this tenant";

	public static final String UPDATE_ERROR_KEY = "EG_INVALID_ACTION_UPDATE";
	...
	public static final String UPDATE_FEEDBACK_ERROR_KEY = "EG_UPDATE_RATING_FEEDBACK_NOT_APPLICABLE";

	public static final String UNEQUAL_REQUEST_SIZE_KEY = "EG_REQUEST_UNEQUAL_SIZES";
	public static final String UNEQUAL_REQUEST_SIZE_MSG = "Services and ActionInfo must be of same size";

	public static final String CREATE_ADDRESS_COMBO_ERROR_KEY = "EG_CREATE_ADDRESS_ERROR";
	...
	public static final String ASSIGNEE_MISSING_FOR_ACTION_ASSIGN_REASSIGN_KEY = "EG_UPDATE_ASSIGN_REASSIGN";
	...
	public static final String UNAUTHORIZED_USER_KEY = "EG_INVALID_USER";

	public static final String MISSING_USERTYPE_CODE = "EG_REQUESTINFO_USERTYPE_MISSING";
	public static final String MISSING_USERTYPE_MSG = "Unauthenticated user, user type is missing in the request.";

	public static final String MISSING_ROLE_USERID_CODE = "EG_USER_DATA_MISSING";
	public static final String MISSING_ROLE_USERID_MSG = "Unauthenticated user. The combination Id, Roles and Tenant is invalid .";

	public static final String MISSING_USERINFO_CODE = "EG_USERINFO_MISSING";
	public static final String MISSING_USERINFO_MSG = "Unauthenticated user, userInfo missing in the request.";

	public static final String INVALID_ROLE_CODE = "EG_INVALID_ROLE";
	public static final String INVALID_ROLE_MSG = "Inavlid role: ";

	public static final String INVALID_START_END_DATE_CODE = "EG_INVALID_START_END_DATE";
	public static final String INVALID_START_END_DATE_MSG = "startDate or endDate cannot be greater than currentDate";

	public static final String INVALID_START_DATE_CODE = "EG_INVALID_START_DATE";
	public static final String INVALID_START_DATE_MSG = "startDate cannot be greater than endDate";

	public static final String INVALID_PARTIAL_SERVICEREQUESTID_CODE = "EG_INVALID_PARTIAL_SERVICEREQUESTID";
	...
	public static final String INVALID_SERVICEREQUESTID_CODE = "EG_INVALID_SERVICEREQUESTID";
	public static final String INVALID_SERVICEREQUESTID_MSG = "Request object does not exist for the given ids: ";

	public static final String INVALID_SERVICECODE_CODE = "EG_INVALID_SERVICECODE";
	public static final String INVALID_SERVICECODE_MSG = "Following Service codes are invalid: ";

	public static final String INVALID_ACTION_ON_STATUS_CODE = "EG_INVALID_ACTION_ON_STATUS";
	...
	public static final String INVALID_ACTION_FOR_ROLE_CODE = "EG_INVALID_ACTION_FOR_ROLE";
	...
	public static final String INVALID_ACTION_FOR_DGRO_CODE = "EG_INVALID_ACTION_FOR_DGRO";
	...
	public static final String INVALID_ACTION_FOR_GRO_CODE = "EG_INVALID_ACTION_FOR_GRO";
	...
	public static final String INVALID_REQUESTS_ON_TENANT_CODE = "EG_INVALID_REQUESTS_ON_TENANT";
	...
	public static final String INACTIVE_COMPLAINTS_FOR_UPDATE_CODE = "EG_INACTIVE_COMPLAINTS_FOR_UPDATE";
	...
	public static final String INVALID_ADDRESS_DETAIL_CODE = "EG_INVALID_ADDRESS_DETAIL_CODE";
	public static final String INVALID_ADDRESS_DETAIL_MSG = "service.addressDetail cannot be null";

	public static final String INVALID_MOHALLA_CITY_CODE = "EG_INVALID_MOHALLA_CITY_CODE";
	...
	public static final String INVALID_ACTION_REOPEN_EXPIRED_CODE = "EG_INVALID_ACTION_REOPEN_EXPIRED_CODE";
	...
	public static final String INVALID_AUTOROUTING_CODE = "EG_INVALID_AUTOROUTING_CODE";
	public static final String INVALID_AUTOROUTING_MSG = "Autorouting dat cannot be null";

	public static final String INVALID_ID_CODE = "EG_INVALID_ID";
	public static final String INVALID_ID_MSG = "ID cannot be null";

	public static final String NO_DATA_FOUND_CODE = "EG_NO_DATA_FOUND_CODE";
	public static final String NO_DATA_FOUND_MSG = "No record exists";

	public static final String AUTOROUTING_DATA_EXISTS_CODE = "EG_AUTOROUTING_DATA_EXISTS_CODE";
	...
	public static final String AUTOROUTING_UPDATION_FAILED_CODE = "EG_AUTOROUTING_UPDATE_FAILED_CODE";
	public static final String AUTOROUTING_UPDATION_FAILED_MSG = "Autorouting data updation failed.";

	public static final String INVALID_SWATCHBHARATUSERID_CODE = "EG_INVALID_SWATCHBHARATUSERID";
	public static final String INVALID_SWATCHBHARATUSERID_MSG = "User UUID is blank or empty";

	public static final String INVALID_SWATCHBHARATFILEDID_CODE = "EG_INVALID_SWATCHBHARATFILEDID";
	public static final String INVALID_SWATCHBHARATFILEDID_MSG = "File Id is blank or empty";

	public static final String ERROR_CODE_GRIVENCE = "NODATA";
	public static final String ERROR_MESSAGE_GRIVENCE = "No data found for given date range";
}
