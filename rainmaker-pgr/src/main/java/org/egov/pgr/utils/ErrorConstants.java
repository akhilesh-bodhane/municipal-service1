...
public class ErrorConstants {
	...
	public static final String INVALID_SWATCHBHARATUSERID_CODE = "EG_PGR_INVALID_SWATCHBHARATUSERID";
	public static final String INVALID_SWATCHBHARATUSERID_MSG = "User UUID is blank or empty";

	public static final String INVALID_SWATCHBHARATFILEDID_CODE = "EG_PGR_INVALID_SWATCHBHARATFILEDID";
