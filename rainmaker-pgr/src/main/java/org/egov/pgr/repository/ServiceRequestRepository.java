...
//		}
		...
		if (serviceReqSearchCriteria.getOffset() != null && serviceReqSearchCriteria.getOffset() > -1) {
			whereStr.append(" offset ").append(serviceReqSearchCriteria.getOffset());
		}
		
		if (serviceReqSearchCriteria.getLimit() != null && serviceReqSearchCriteria.getLimit() > -1) {
			whereStr.append(" limit ").append(serviceReqSearchCriteria.getLimit());
		}
