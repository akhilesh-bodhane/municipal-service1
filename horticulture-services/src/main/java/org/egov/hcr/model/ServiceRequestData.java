...
public class ServiceRequestData {
	...
	@JsonProperty("is_range_forest_officer_report")
	private Boolean is_range_forest_officer_report;

	@JsonProperty("range_forest_officer_report_document")
	private org.json.simple.JSONObject range_forest_officer_report_document;

	@JsonProperty("range_forest_officer_report_document_json")
	private String range_forest_officer_report_document_json;

	@JsonProperty("isPremises")
	private String isPremises = null;

	@JsonProperty("isTreelies")
	private String isTreelies = null;

	@JsonProperty("sketchPlanOfTree")
	private String sketchPlanOfTree = null;
