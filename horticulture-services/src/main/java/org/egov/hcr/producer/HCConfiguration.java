...
public class HCConfiguration {
	...
	public MappingJackson2HttpMessageConverter jacksonConverter(ObjectMapper objectMapper) {
		...
		private String saveTransitionTopic;
	 	...
	 	@Value("${egov.horticulture.default.limit}")
	    private Integer defaultLimit;

	    @Value("${egov.horticulture.default.offset}")
	    private Integer defaultOffset;

	    @Value("${egov.horticulture.max.limit}")
	...
	//Allowed Search Parameters
	 ...
	 //Idgen Config
	    ...
	    @Value("${egov.idgen.horticulture.serviceRequestNum.name.mcc}")
	    private String applicationNumberIdgenNameMcc;
	    
	    @Value("${egov.idgen.horticulture.serviceRequestNum.format.mcc}")
	    private String applicationNumberIdgenFormatMcc;

	    @Value("${egov.idgen.horticulture.serviceRequestNum.name.ut}")
	    private String applicationNumberIdgenNameUt;
	    
	    @Value("${egov.idgen.horticulture.serviceRequestNum.format.ut}")
	    private String applicationNumberIdgenFormatUt;
	    
	    @Value("${egov.idgen.horticulture.serviceRequestNum.name.forest}")
	    private String applicationNumberIdgenNameForest;
	    
	    @Value("${egov.idgen.horticulture.serviceRequestNum.format.forest}")
	    private String applicationNumberIdgenFormatForest;
   ...
   // Localization
	...
	// SLA days configration
		...
		@Value("${egov.horticulture.sla.daysconfig}")
		private int slaDays;

		@Value("${egov.horticulture.sms.template}")
