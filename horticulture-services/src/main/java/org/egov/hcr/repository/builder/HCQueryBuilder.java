...
public class HCQueryBuilder {
	...
	private static final String DASHBOARD_QUERY = "select service_type,service_request_status,to_char(to_timestamp(cast(createdtime/1000 as bigint))::date ,'DD/MM/YYYY')as createdtime,locality,service_type_name from eg_hc_service_request hc ";
