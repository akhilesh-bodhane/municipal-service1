...
private JdbcTemplate jdbcTemplate;
	...
	@Autowired
	public StreetVendorRepository(Producer producer, StreetVendorConfiguration config,StreetVendorRowMapper streetVendorRowMapper,JdbcTemplate jdbcTemplate) {
		...
		try {			
				return streetVendorDataList = jdbcTemplate.query(StreetvendorQueryBuilder.GET_STREET_VENDOR_DATA_QUERY,
						new Object[] {  streetVendorData.getCovNo(), 
								        streetVendorData.getCovNo(),
								        streetVendorData.getVendorName(),
								        streetVendorData.getVendorName(),
								        streetVendorData.getCategory(),
								        streetVendorData.getCategory()								        
