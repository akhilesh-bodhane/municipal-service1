package org.egov.streetvendor.common;
...
public class CommonConstants {
	...
	public static final String STREET_VENDOR_CREATION_EXCEPTION_CODE = "STREET_VENDOR_CREATION_EXCEPTION";
	public static final String STREET_VENDOR_GET_EXCEPTION_CODE = "STREET_VENDOR_GET_EXCEPTION";
	public static final String STREET_VENDOR_GET_DETAILS_EXCEPTION_CODE = "STREET_VENDOR_GET_DETAILS_EXCEPTION";
	...
	public static final String MDMS_PM_PATH = "$.MdmsRes.TemporaryStall";
	public static final String MDMS_TAXHEAD_PATH = "$.MdmsRes.TemporaryStall.Festival";
	public static final String MDMS_TAXHEAD_SIZE_PATH = "$.MdmsRes.TemporaryStall.size";
	public static final String MDMS_TAXHEAD_STALL_CONFIG_PATH = "$.MdmsRes.TemporaryStall.Stallconfig";
