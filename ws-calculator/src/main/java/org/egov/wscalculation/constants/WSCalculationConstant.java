...
public class WSCalculationConstant {
	...
	public static final String APPLICATION_FEE_DEMAND_END_DATE = "1869676199000";
	...
	public static final String WS_TEMP_APP_CHARGES_PREV = "WSTempConAppChargesPrev";
	
	public static final String WS_TEMP_BILLING_CHARGES = "WSTempConBillingSlab";
	
	public static final String WS_TEMP_BILLING_CHARGES_PREV = "WSTempConBillingSlabPrev";
	
	public static final String WS_REGULAR_CHARGES = "PipeSize";
	
	public static final String WS_REGULAR_CHARGES_PREV = "PipeSizePrev";
	...
	public static final String	WS_WATER_ACTIVITY_PREV = "WaterActivityPrev";
	...
	public static final String WS_TT_WATER_ACTIVITY = "TT_WATER_CONNECTION";
