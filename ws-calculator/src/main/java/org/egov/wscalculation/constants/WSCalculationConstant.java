...
public class WSCalculationConstant {
	...
	public static final String WS_TEMP_APP_CHARGES_PREV = "WSTempConAppCharges22";
	
	public static final String WS_TEMP_BILLING_CHARGES = "WSTempConBillingSlab";
	
	public static final String WS_TEMP_BILLING_CHARGES_PREV = "WSTempConBillingSlab22";
	
	public static final String WS_REGULAR_CHARGES = "PipeSize";
	
	public static final String WS_REGULAR_CHARGES_PREV = "PipeSize22";
	...
	public static final String	WS_WATER_ACTIVITY_PREV = "WaterActivity22";
